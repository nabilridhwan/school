...
CREATE TABLE `discounts` (
  ...
  `discount_amount_id` int NOT NULL,
  `discount_date_id` int NOT NULL,
  PRIMARY KEY (`discount_id`),
  KEY `fk_amt_idx` (`discount_amount_id`),
  KEY `fk_date_idx` (`discount_date_id`),
  KEY `fk_product_id_discount_idx` (`productid`),
